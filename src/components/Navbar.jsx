    ...
    return (
        <div className="fixed top-0 left-0 w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300 z-50 shadow-md">
            ...
            <ul className="hidden md:flex">
                ...
                <li className="px-4 py-2 hover:bg-pink-600 hover:text-white rounded-md transition duration-300"><Link to="experience" smooth={true} duration={500}>Experience</Link></li>
